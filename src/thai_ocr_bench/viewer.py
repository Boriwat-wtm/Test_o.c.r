...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* ให้คอลัมน์ย่อได้เมื่อที่ไม่พอ ไม่ใช่ล้นออกไปโดนตัด
     เดิมตั้ง flex:1 0 340px (ห้ามย่อ) พอกลุ่มมีสองแบบ สองคอลัมน์กับช่องไฟ
     รวมเป็น 692px แต่ฝั่งขวากว้างจริงราว 673px จึงล้นออกไป 19px
     แล้วบรรทัดขวาสุดถูกตัดหายทั้งที่ข้อความอยู่ครบ ดูเหมือน OCR อ่านไม่จบ
     ยอมให้ย่อลงถึง 260px ก่อน แล้วค่อยเลื่อนแนวนอนถ้ายังไม่พอจริง ๆ */
